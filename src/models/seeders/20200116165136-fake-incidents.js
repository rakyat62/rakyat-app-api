...
const data = new Array(1000).fill({}).map(() => ({
  information: faker.random.words(getRandomNumber(5, 40)),
  status: getRandomStatus(),
  locationAddress: faker.address.city(),
  locationLat: getRandomNumber(-7, -6, 7),
  ...
  createdAt: moment().year(2019).month(getRandomNumber(1, 12)).date(getRandomNumber(1, 28))
